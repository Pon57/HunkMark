...
test("does not auto-return after the user points elsewhere while collapse state saves", async () => {
  const html = duplicateHunkFixture().replace(
    '<div class="file-header">',
    '<div class="file-header" style="position: sticky; top: 0; height: 40px">',
  );
...
test("keeps auto-return pending across layout-only scroll events", async () => {
  const html = duplicateHunkFixture().replace(
    '<div class="file-header">',
    '<div class="file-header" style="position: sticky; top: 0; height: 40px">',
  );
...
test("cancels auto-return after scroll-only user movement", async () => {
  const html = duplicateHunkFixture().replace(
    '<div class="file-header">',
    '<div class="file-header" style="position: sticky; top: 0; height: 40px">',
  );
